...
use crate::utils::{all_trait_name, available_name, has_name};
...
pub fn marker(input: TokenStream) -> TokenStream {
    ...
    let all_trait = all_trait_name(&name);
    ...
    let all_docs = [
        &format! {"A trait indicating that all Systems in a Tag or SystemsList support a {}.", name},
        "",
        "this trait has autoimplementations to make it work automatically. No need for you to \
    ...
    TokenStream::from(quote! {
        ...
        #(#[doc=#available_docs])*
        #vis trait #available_trait where
        ...
        impl<Sys> #all_trait for Tag<Sys>
        where
            Sys: SystemsList + SystemDefinition + #all_trait
        {}
        #[automatically_derived]
        #[allow(unused_qualifications)]
        impl<Head, Tail> #all_trait for (Head, Tail) where
            Head: SystemDefinition + #available_trait,
            Tail: #all_trait + SystemDefinition + SystemsList,
        {}
        #[automatically_derived]
        #[allow(unused_qualifications)]
        impl<Head> #all_trait for (Head, ()) where
            Head: SystemDefinition + #available_trait
        {}
