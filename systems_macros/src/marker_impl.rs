...
pub fn marker(input: TokenStream) -> TokenStream {
    ...
    let has_docs = [
        &format!(
            "Systems that support a {} should implement this trait.",
            name
        ),
        "",
        &format!(
            "Only Systems whose SystemDefinition implements [`{}`] can implement this trait.",
            available_trait
        ),
        "",
    ...
    let available_docs = [
        &format!(
            "System Definitions need to implement this to signify the System supports a {}",
            name
        ),
        "",
        &format!(
            "A system can only implement {} if the corresponding System implements this trait.",
            has_trait
        ),
        "",
        "This trait is autogenerated by the [`marker`] macro",
