...
pub(crate) mod features {
    ...
    pub(crate) mod log {
        ...
        #[cfg(feature = "log")]
        pub(crate) use log::{debug, info, warn, error, trace};
        #[cfg(not(feature = "log"))]
        pub(crate) use plating_macros::{noop as debug, noop as info, noop as warn, noop as error, noop as trace};
    }
    ...
    pub(crate) mod serde {
        ...
        #[cfg(feature = "serde")]
        pub(crate) use serde::{de::Deserialize as DeserializeTrait, ser::Serialize as SerializeTrait};
